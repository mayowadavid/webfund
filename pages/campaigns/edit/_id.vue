      ...
      <div class="w-full">
        ...
        <div class="sm:grid grid-cols-12 gap-x-12">
          ...
          <div class="col-span-5 input-file my-auto">
            <v-alert color="yellow" :message="err" :dismissable="dismissable" />
            <input
              type="file"
              id="dropFile"
              multiple
            ...
            <div class="mb-6"></div>
            <div v-if="Image.length > 0" class="grid grid-cols-2 gap-6">
              ...
              >
                <svg
                  @click.prevent="removeImage(index, file)"
                  width="19"
                  height="19"
                  viewBox="0 0 19 19"
                  fill="none"
                ...
                >
                  ...
                  />
                  <path
                    d="M13.8 4.89998C13.2 4.89998 12.6 4.49998 12.5 3.89998L12.3 2.89998C12.2 2.49998 11.8 2.09998 11.3 2.09998H8C7.5 2.09998 7.1 2.39998 7 2.89998L6.8 3.89998C6.7 4.49998 6.1 4.89998 5.5 4.89998"
                    fill="white"
                  />
                  <path
                    d="M13.8 4.89998C13.2 4.89998 12.6 4.49998 12.5 3.89998L12.3 2.89998C12.2 2.49998 11.8 2.09998 11.3 2.09998H8C7.5 2.09998 7.1 2.39998 7 2.89998L6.8 3.89998C6.7 4.49998 6.1 4.89998 5.5 4.89998"
                ...
                <img
                  class="mb10 h-40 rounded-lg m-auto flex-inline"
                  :src="file.url"
                  alt=""
                />
              </div>
  ...
  methods: {
    ...
    uploadImages(e) {
      ...
      if (files) {
        ...
        result.length <= 0 &&
          ((err =
            'unsupported image type* accepted image jpg/png or file size is greater than 5mb'),
          (dismissable = true))
        this.files = [...result]
        const temporaryUrl =
          result.length > 0 &&
